...
const NewSalesPaymentTable = (showFormHandler, actions) => {
  return [
    {
      align: "left",
      title: "Payment Date",
    ...
    },
    {
      ...
      title: "Payment Mode",
      val: "paymentMode",
      render: (rowData) => <span>{rowData.paymentMode?.paymentModeName || rowData.paymentMode}</span>,
    },
    {
      align: "right",
      title: "Amount",
    ...
    },
    {
      ...
      title: "TDS",
      val: "tds",
      render: (rowData) => <span>{rowData.tds || 0}</span>,
    },
    {
      align: "right",
      title: "Paid",
...
export default NewSalesPaymentTable;