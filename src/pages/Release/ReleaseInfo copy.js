...
const componentMap = {
    "/master/customer": React.lazy(() => import("../Spinner")),
    "/sales/neworder": React.lazy(() => import("../Spinner")),
    "/process/querySolutions": React.lazy(() => import("../../pages/QueryAndSolution/Wizard/ActivityWiz")),
                        ...
                        {activityList.length > 0 ? (
                            activityList.map((item, idx) => (
                                <div
                                    ...
                                    style={{ cursor: item.activity.activityPath ? "pointer" : "default" }}

                                >
                                    <div className={classes.column}
                                        onClick={() => {
                                            console.log("path ==>", item.activity.activityPath)
                                            if (item.activity.activityPath && componentMap[item.activity.activityPath]) {
                                                console.log("path ==>", item.activity.activityPath)
                                                setSelectedDevPath(item.activity.activityPath);
                                            }
                                        }}>
